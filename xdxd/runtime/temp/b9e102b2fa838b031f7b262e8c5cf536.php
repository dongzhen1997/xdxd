<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/usr/share/nginx/html/xdxd/public/../application/index/view/address/addressAdd.html";i:1558188669;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<section class="aui-flexView">
    <header class="aui-navBar aui-navBar-fixed b-line">
        ...
        <?php elseif($change == 2): ?>
        <a href="<?php echo url('index/Details/details'); ?>?Id=<?php echo $id; ?>" class="aui-navBar-item">
            <i class="icon icon-return"></i>
        </a>
        <?php elseif($change == 3): ?>
        <a href="<?php echo url('index/Gradeshop/gradeshop'); ?>" class="aui-navBar-item">
            <i class="icon icon-return"></i>
        </a>
        <?php endif; ?>
    ...
    <form action="<?php echo url('index/Address/addressAdd'); ?>"method="post">
