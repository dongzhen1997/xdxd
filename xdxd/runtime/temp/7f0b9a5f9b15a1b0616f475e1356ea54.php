<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:86:"/usr/share/nginx/html/xdxd/public/../application/admin/view/classify/classifyList.html";i:1555502422;s:66:"/usr/share/nginx/html/xdxd/application/admin/view/common/meta.html";i:1550898692;s:68:"/usr/share/nginx/html/xdxd/application/admin/view/common/header.html";i:1555570256;s:66:"/usr/share/nginx/html/xdxd/application/admin/view/common/menu.html";i:1555502150;s:68:"/usr/share/nginx/html/xdxd/application/admin/view/common/footer.html";i:1551351184;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray">
				<span class="l">
					...
					<a href="javascript:;" onclick="member_add('添加商品分类','<?php echo url('admin/Classify/classifyAdd'); ?>','','510')" class="btn btn-primary radius">
			...
			<div class="mt-20">
				<table class="table table-hover table-border table-bordered table-bg table-sort">
					...
					<tbody>
					<?php if(is_array($c_list) || $c_list instanceof \think\Collection || $c_list instanceof \think\Paginator): $i = 0; $__LIST__ = $c_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$co): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							<td><input type="checkbox" value="<?php echo $co['Id']; ?>" key="k" name=""></td>
							<td><?php echo $co['Id']; ?></td>
							<td><?php echo $co['classify_name']; ?></td>
							<td><?php echo $co['classify_status']; ?></td>
							<td class="td-status">
							...
							<td class="td-manage">
								...
								<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('admin/goods/classifyEdit'); ?>?id=<?php echo $co['Id']; ?>',<?php echo $co['Id']; ?>,'','510')" class="ml-5" style="text-decoration:none">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a>
